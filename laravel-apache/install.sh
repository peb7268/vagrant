...
chmod -R a+rw $PROJECT_NAME/public/packages
chmod -R a+rw $PROJECT_NAME/app/config/packages
chmod -R a+rw $PROJECT_NAME/app/storage
...
#OR to install a project that is already working:
#cd /vagrant; git clone https://peb7268:erford7268@github.com/Infosurv/icev2.git intengo;

#Setup the DB
cd app/config;
sed -i "s/'database'  => 'database'/'database'  => '$PROJECT_NAME'/" ./database.php
...
echo "alias app='cd /vagrant/$PROJECT_NAME/'" >> /home/vagrant/.bash_profile
echo "alias reload='source ~/.bash_profile'" >> /home/vagrant/.bash_profile
source /home/vagrant/.bash_profile

#Run this in the non vagrant client terminal and you should be set.
#sudo chmod -R 777 intengo/app/storage/

#App should be accessible at dev.php.com:8081/admin !! :)